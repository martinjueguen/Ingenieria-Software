...
2. Estímulo: El servidor falla.
3. Entorno: Operación normal.
4. Artefacto: Servidor / Granja de servidores.
5. Respuesta: El sistema informa al operador y continúa operando.
6. Medida de respuesta: Sin tiempo de inactividad (no downtime).