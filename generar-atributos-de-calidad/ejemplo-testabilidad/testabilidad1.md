...
2. Estímulo: Completa una unidad de código
3. Ambiente: Entorno de desarrollo
4. Artefacto: Unidad de código (Code unit)
5. Respuesta: Realiza una secuencia de pruebas y captura sus resultados
6. Medida de la Respuesta: Cobertura de rutas del 85% alcanzada en un tiempo de 30 minutos