...
4. Artefacto: Servicio de autenticación/autorización
5. Respuesta: El nuevo servicio es probado internamente y posteriormente desplegado en los servidores de producción
6. Medida de la Respuesta: Despliegue completado en un máximo de 40 horas y con no más de 120 horas-persona de esfuerzo, sin introducir defectos y sin violar ningún SLA
1. Tipo escenario: Modificabilidad